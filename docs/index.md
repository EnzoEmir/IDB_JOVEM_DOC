...
Bem-vindo à documentação do projeto desenvolvido para a Igreja de Deus - IDB Jovem e Teen.

## Escopo funcional atual

- Página de login
- Calendário com os eventos
- Filtragem de voluntários para suporte em eventos
